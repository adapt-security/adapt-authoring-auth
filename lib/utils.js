...
class Utils {
  ...
  */
  static authenticate(req) {
    return new Promise((resolve, reject) => {
      ...
      */
      const scopes = require(require('path').join(process.cwd(), 'reqScopes.json'));
      req.auth = {
  ...
  */
  ...
  /**
  * Checks whether the provided scopes are authorised to access a specific
  * URL/HTTP method combination
  * @return {Boolean}
  */
