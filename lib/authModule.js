...
class AuthModule extends AbstractModule {
  ...
  async init() {
    ...
    const disable = this.getConfig('disable');
  ...
  */
  ...
  registerAccessChecker(route, method, checkerFunc) {
    if(!this.accessCheckers[method.toLowerCase()][route]) {
      this.accessCheckers[method.toLowerCase()][route] = [];
    }
    this.accessCheckers[method.toLowerCase()][route].push(checkerFunc);
  }
